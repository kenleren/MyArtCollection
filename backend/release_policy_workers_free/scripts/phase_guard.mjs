...
if (phase === "preserve-sbom") preserve();
  ...
  const exactB = ["M\tbackend/release_policy_trust/evidence/review/candidate-tree.v1.jsonl", "M\tbackend/release_policy_trust/evidence/review/final-candidate.v1.json", "M\tbackend/release_policy_trust/evidence/review/reproducibility.v1.json", "D\tbackend/release_policy_workers_free/evidence/artifact-manifest.v1.json", "A\tbackend/release_policy_workers_free/evidence/artifact-manifest.v2.json", "M\tbackend/release_policy_workers_free/evidence/sbom.spdx.json"];
