...
export function artifactDrift(recorded: Readonly<Record<string, string>>, working: Readonly<Record<string, string>>, anchored: Readonly<Record<string, string>>): string[] {
